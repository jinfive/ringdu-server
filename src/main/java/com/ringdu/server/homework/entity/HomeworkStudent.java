...
@Table(
        ...
        uniqueConstraints = @UniqueConstraint(
                name = "uk_homework_students_homework_student",
                columnNames = {"homework_id", "student_profile_id"}
        ),
        indexes = {
                ...
                @Index(name = "idx_homework_students_academy_student", columnList = "academy_id, student_profile_id")
        }
)
...
public class HomeworkStudent extends BaseEntity {
    ...
    private HomeworkStudent(Long homeworkId, Long academyId, Long classId, Long studentProfileId) {
    ...
    public static HomeworkStudent create(Long homeworkId, Long academyId, Long classId, Long studentProfileId) {
        return new HomeworkStudent(homeworkId, academyId, classId, studentProfileId);
    }
