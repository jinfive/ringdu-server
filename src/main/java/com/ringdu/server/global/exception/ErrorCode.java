...
public enum ErrorCode {
    ...
    HOMEWORK_STUDENT_NOT_FOUND(HttpStatus.NOT_FOUND, "학생별 숙제 기록을 찾을 수 없습니다."),
    HOMEWORK_STUDENT_NOT_IN_CLASS(HttpStatus.BAD_REQUEST, "담당 수업의 재원 학생에게만 숙제를 배정할 수 있습니다."),
